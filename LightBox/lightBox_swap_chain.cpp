...
VkResult LightBoxSwapChain::acquireNextImage(uint32_t *imageIndex) {
  vkWaitForFences(
      device.device(),
      1,
...
VkResult LightBoxSwapChain::submitCommandBuffers(
...
void LightBoxSwapChain::createImageViews() {
...
void LightBoxSwapChain::createRenderPass() {
...
void LightBoxSwapChain::createFramebuffers() {
...
void LightBoxSwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR LightBoxSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR LightBoxSwapChain::chooseSwapPresentMode(
...
VkExtent2D LightBoxSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat LightBoxSwapChain::findDepthFormat() {
